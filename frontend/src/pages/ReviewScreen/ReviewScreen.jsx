  ...
  return (
    <>
      ...
      <main className="relative flex flex-col items-center justify-center p-2 sm:p-4 min-h-screen">
        <div className="xl:w-[500px] md:w-[500px] sm:w-[400px] w-full p-3">
          <div
            className={`${styles["flashcard-container"]} gap-2 flex flex-col justify-center mb-8 xl:w-[500px] md:w-[500px] sm:w-[400px] w-full`}
          >
            <div className="flex w-full flex-col justify-start align-center mb-8 sm:mb-8">
